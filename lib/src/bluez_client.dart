...
class BlueZException extends DBusMethodResponseException {
  ...
  String get message => response.values.isNotEmpty
      ? (response.values[0] as DBusString).value
      : '';
  ...
  Future<DBusMethodResponse> handleMethodCall(DBusMethodCall methodCall) async {
    ...
    if (methodCall.name == 'Release') {
      ...
      return (await agent.requestPinCode(
              bluezClient._getDevice(methodCall.values[0] as DBusObjectPath)!))
          .response;
      ...
      return (await agent.displayPinCode(
              bluezClient._getDevice(methodCall.values[0] as DBusObjectPath)!,
              (methodCall.values[1] as DBusString).value))
          .response;
      ...
      await agent.displayPasskey(
          bluezClient._getDevice(methodCall.values[0] as DBusObjectPath)!,
          (methodCall.values[1] as DBusUint32).value,
          (methodCall.values[2] as DBusUint16).value);
      return DBusMethodSuccessResponse();
      ...
      return (await agent.authorizeService(
              bluezClient._getDevice(methodCall.values[0] as DBusObjectPath)!,
              BlueZUUID.fromString((methodCall.values[1] as DBusString).value)))
          .response;
